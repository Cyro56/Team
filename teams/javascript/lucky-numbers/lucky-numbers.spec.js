...
describe('luckyNumber', () => {
  test('identifies palindromic numbers', () => {
    expect(luckyNumber(1551)).toBe(true);
...
describe('errorMessage', () => {
  ...
  test('returns an empty string for valid inputs', () => {
    ...
    expect(errorMessage('  784   ')).toBe(''); //porque esse caso está passando?
    expect(errorMessage('5e3')).toBe(''); //porque esse caso está passando?
  });
});
